...
?>
<title>Demo Login and Registration Script with PHP, MySQL</title>
...
<div class="container">
<h2>Login and Registration Script with PHP, MySQL</h2>	
	<div class="row">
			...
			<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="signupform">
				<fieldset>
					...
					<div class="form-group">
						...
						<input type="password" name="password" placeholder="Password" id="myInput" required class="form-control" />
					...
					<div class="form-group">
						...
						<input type="password" name="cpassword" placeholder="Confirm Password" id="myInput" required class="form-control" />
						<input type="checkbox" onclick="myFunction()"> Show Password
